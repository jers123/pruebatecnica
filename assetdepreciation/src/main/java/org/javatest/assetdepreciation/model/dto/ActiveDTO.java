...
import static org.javatest.assetdepreciation.utils.Constants.ACTIVE_DEPRECIATION_YPE_NOT_NULL;
import static org.javatest.assetdepreciation.utils.Constants.ACTIVE_DESCRIPTION_SIZE;
import static org.javatest.assetdepreciation.utils.Constants.ACTIVE_NAME_NOT_BLANK;
...
import static org.javatest.assetdepreciation.utils.Constants.ACTIVE_SERIAL_NOT_BLANK;
...
public class ActiveDTO {
    ...
    @NotBlank(message = ACTIVE_SERIAL_NOT_BLANK)
    ...
    @NotBlank(message = ACTIVE_NAME_NOT_BLANK)
    ...
    @NotNull(message = ACTIVE_DEPRECIATION_YPE_NOT_NULL)
