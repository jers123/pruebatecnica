...
public final class Constants {
    ...
    public static final String ACTIVE_NAME_NOT_BLANK = "El nombre del activo no puede ser vacío.";
    ...
    public static final String ACTIVE_SERIAL_NOT_BLANK = "El serial del activo no puede ser vacío.";
    ...
    public static final String ACTIVE_DEPRECIATION_YPE_NOT_NULL = "El tpo de depresiación del activo no puede ser nulo.";
